        ...
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <header class="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white p-6 md:p-8">
                ...
                <p class="text-center text-sm md:text-base mt-2 opacity-90">
                    Isi detail di bawah untuk memesan layanan AC. Kami akan segera menghubungi Anda.
                </p>
            </header>
                ...
                <form action="{{ route('customer.orders.store') }}" method="POST" class="space-y-8" id="order-form">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="name" name="name" required
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('name') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="tel" id="phone" name="phone" required
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('phone') border-red-500 @enderror"
                    ...
                    <section class="group">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="service_id" id="service_id" required
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('service_id') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="metode_pembayaran" id="metode_pembayaran" required
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('metode_pembayaran') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_service_diharapkan" id="tanggal_service_diharapkan"
                                        required min="{{ date('Y-m-d') }}" value="{{ old('tanggal_service_diharapkan') }}"
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('tanggal_service_diharapkan') border-red-500 @enderror">
                                    <i
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="time" name="jam_service_diharapkan" id="jam_service_diharapkan" required
                                        step="300" value="{{ old('jam_service_diharapkan') }}"
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('jam_service_diharapkan') border-red-500 @enderror">
                                    <i
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <textarea name="alamat_service" id="alamat_service" rows="4" required
                                        class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('alamat_service') border-red-500 @enderror"
                                        placeholder="Contoh: Jl. Merdeka No. 10, ...">{{ old('alamat_service', Auth::user()->address ?? '') }}</textarea>
                        ...
                        <div class="mt-4 bg-gray-50 p-4 rounded-lg">
                            <p class="text-sm text-gray-600">Estimasi Harga:
                                <span id="price-preview" class="font-semibold text-yellow-600">Rp0</span>
                            </p>
                        </div>
                    </section>

                    {{-- ========== SECTION 3: DESKRIPSI MASALAH ========== --}}
                    <section class="group">
                        <h2 class="text-lg md:text-xl font-semibold text-gray-800 mb-4 flex items-center">
                            <i class="fas fa-info-circle text-yellow-500 mr-3"></i> Deskripsi Tambahan
                        </h2>
                        <p class="text-gray-600 mb-6 text-sm">Jelaskan masalah AC atau informasi tambahan.</p>
                        <div class="relative">
                            <textarea name="deskripsi_masalah" id="deskripsi_masalah" rows="5"
                                class="w-full px-4 py-3 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-yellow-500 @error('deskripsi_masalah') border-red-500 @enderror"
                    ...
                    <div class="flex justify-center mt-10">
                        <button type="submit"
                            class="w-full md:w-auto px-10 py-4 bg-yellow-600 text-white font-semibold rounded-full shadow-md hover:bg-yellow-700 focus:outline-none focus:ring-4 focus:ring-yellow-300 transition duration-300 ease-in-out transform hover:scale-105"
                            id="submit-button">
