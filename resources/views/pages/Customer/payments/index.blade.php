        ...
        @if ($payments->isEmpty())
            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-6 md:p-8 rounded-xl shadow-lg max-w-2xl mx-auto text-center"
                ...
                <a href="{{ route('customer.orders.index') }}"
                    class="mt-6 inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-105 shadow-md">
                ...
                @foreach ($payments as $payment)
                    <div
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="font-semibold text-gray-800">Pembayaran untuk Layanan #{{ $payment->order_id }}</h3>
                            <span
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            <a href="{{ route('customer.payments.show', $payment->id) }}"
                                class="inline-flex items-center justify-center px-4 py-2 bg-yellow-500 text-white font-semibold rounded-full text-sm hover:bg-yellow-600 transition duration-300 ease-in-out transform hover:scale-105 shadow-md w-full sm:w-auto">
                            ...
                            @if ($payment->status_pembayaran === 'pending' || $payment->status_pembayaran === 'gagal')
                                <a href="{{ route('customer.payments.upload', $payment->id) }}"
                                    class="inline-flex items-center px-4 py-2 bg-blue-500 text-white font-semibold rounded-full text-sm hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 shadow-md w-full sm:w-auto">
            ...
            <div class="hidden lg:block overflow-x-auto bg-white rounded-xl shadow-lg border border-gray-100"
                ...
                <table class="min-w-full text-left text-sm text-gray-700" id="payments-table">
                    <thead class="bg-yellow-50">
                        <tr>
                            <th class="px-6 py-4 font-semibold text-gray-800">Nama Layanan</th>
                            <th class="px-6 py-4 font-semibold text-gray-800 cursor-pointer" data-sort="jumlah_bayar">Jumlah
                                Bayar <i class="fas fa-sort text-gray-400 ml-1"></i></th>
