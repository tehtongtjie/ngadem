                        ...
                        <div class="bg-gray-50 p-6 rounded-lg space-y-2">
                            ...
                            <a href="{{ route('customer.orders.show', $payment->order->id) }}"
                                class="inline-flex items-center px-4 py-2 bg-yellow-500 text-white font-semibold rounded-full
                                      hover:bg-yellow-600 transition duration-300 ease-in-out transform hover:scale-105 mt-4">
                                ...
                                @if ($payment->status_pembayaran === 'pending' || $payment->status_pembayaran === 'gagal')
                                    <a href="{{ route('customer.payments.upload', $payment->id) }}"
                                        class="inline-flex items-center px-4 py-2 bg-blue-500 text-white font-semibold rounded-full
                                              hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 mt-4">
                ...
                <div class="flex justify-center mt-10 space-x-4">
                    @if ($payment->status_pembayaran === 'berhasil')
                        <a href="{{ route('customer.payments.download', $payment->id) }}"
                            class="inline-flex items-center px-6 py-3 bg-green-500 text-white font-semibold rounded-full
