@extends('layouts.app') {{-- Pastikan ada layout admin yang sudah mengimpor Tailwind CSS --}}
                ...
                <tbody>
                    @forelse ($customers as $customer)
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">{{ ucfirst($customer->role) }}</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">{{ $customer->created_at->format('d M Y H:i') }}
                                </p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
