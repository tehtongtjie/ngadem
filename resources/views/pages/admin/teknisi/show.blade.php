...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Detail Teknisi</h1>

        <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div class="px-6 py-4 bg-gray-100 border-b border-gray-200">
                <h6 class="text-lg font-semibold text-gray-800">Informasi Teknisi</h6>
            </div>
            <div class="p-6">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200">
                                <th
                                    ...
                                    ID</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">{{ $teknisi->id }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                    Nama</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">{{ $teknisi->name }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                    Email</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">{{ $teknisi->email }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                    Role</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">{{ ucfirst($teknisi->role) }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                ...
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">
                                    {{ $teknisi->detail->area_layanan ?? '-' }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                    Spesialisasi</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">
                                    {{ $teknisi->detail->spesialisasi ?? '-' }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                ...
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">
                                    {{ $teknisi->detail->deskripsi_singkat ?? '-' }}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                    Terdaftar Sejak</th>
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">
                                    {{ $teknisi->created_at->format('d M Y H:i') }}</td>
                            </tr>
                            <tr>
                                <th
                                    class="px-5 py-3 bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wider w-48">
                                ...
                                <td class="px-5 py-3 bg-white text-sm text-gray-900">
                                    {{ $teknisi->updated_at->format('d M Y H:i') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <form action="{{ route('admin.teknisi.destroy', $teknisi->id) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
